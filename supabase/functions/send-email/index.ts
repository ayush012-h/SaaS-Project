  ...
  <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#0A0A0F;color:#E8E8F0;border-radius:16px;overflow:hidden;">
    ...
    name || "there"
      ...
      <p style="font-size:14px;color:#A0A0B8;line-height:1.7;margin:0 0 24px;">
        Welcome to SubTrackr! You just took the first step to stop losing
        money on forgotten subscriptions. The average person wastes
        <strong style="color:#FFD700;">₹2,400/year</strong> on unused subscriptions.
        Let's fix that.
      </p>
      <div style="background:#1A1A2A;border-radius:12px;padding:24px;margin-bottom:24px;">
        <p style="font-size:13px;font-weight:700;color:#6C63FF;margin:0 0 16px;text-transform:uppercase;letter-spacing:1px;">
          Get started in 3 steps
        </p>
        <div style="display:flex;gap:12px;margin-bottom:14px;">
          <span style="font-size:20px;">1️⃣</span>
          <div>
            <div style="font-weight:700;font-size:14px;color:#E8E8F0;">Add your first subscription</div>
            <div style="font-size:12px;color:#666680;">Netflix, Spotify, Adobe — whatever you pay for</div>
          </div>
        </div>
        <div style="display:flex;gap:12px;margin-bottom:14px;">
          <span style="font-size:20px;">2️⃣</span>
          <div>
            <div style="font-weight:700;font-size:14px;color:#E8E8F0;">Set renewal alerts</div>
            <div style="font-size:12px;color:#666680;">Never get surprised by a charge again</div>
          </div>
        </div>
        <div style="display:flex;gap:12px;">
          <span style="font-size:20px;">3️⃣</span>
          <div>
            <div style="font-weight:700;font-size:14px;color:#E8E8F0;">Get AI spending insights</div>
            <div style="font-size:12px;color:#666680;">See exactly where your money goes</div>
          </div>
        </div>
      </div>
      <div style="text-align:center;margin-bottom:28px;">
        <a href="${appUrl}/dashboard"
          style="display:inline-block;background:linear-gradient(135deg,#6C63FF,#3ECFCF);color:#fff;text-decoration:none;padding:14px 36px;border-radius:12px;font-weight:800;font-size:15px;">
          Go to Dashboard →
        </a>
      </div>
      <p style="font-size:12px;color:#444460;text-align:center;">
    ...
    <div style="padding:20px 40px;border-top:1px solid #1E1E2E;text-align:center;">
      <p style="font-size:11px;color:#333350;margin:0;">
        © 2026 SubTrackr ·
        <a href="${appUrl}/privacy" style="color:#555570;">Privacy</a> ·
        <a href="${appUrl}/unsubscribe" style="color:#555570;">Unsubscribe</a>
      </p>
    </div>
  </div>`;
}
...
function proUpgradeTemplate(name: string, appUrl: string): string {
  ...
  <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#0A0A0F;color:#E8E8F0;border-radius:16px;overflow:hidden;">
    <div style="background:linear-gradient(135deg,#6C63FF,#3ECFCF);padding:40px;text-align:center;">
      ...
      <p style="margin:8px 0 0;color:rgba(255,255,255,0.8);font-size:14px;">
        You just unlocked everything SubTrackr has to offer
      </p>
    </div>
    <div style="padding:36px 40px;">
      <p style="font-size:15px;color:#A0A0B8;line-height:1.7;margin:0 0 24px;">
        Hey ${name || "there"}, thank you for upgrading to Pro!
        Here is everything you now have access to:
      </p>
      <div style="background:#1A1A2A;border-radius:12px;padding:24px;margin-bottom:24px;">
        ${
    [
      ...
      ["📤", "CSV and PDF Export", "Download all your data anytime"],
          ...
          <div style="display:flex;gap:14px;margin-bottom:16px;align-items:flex-start;">
            ...
            <div>
              <div style="font-weight:700;font-size:14px;color:#E8E8F0;">${title}</div>
              <div style="font-size:12px;color:#666680;">${desc}</div>
            </div>
          </div>
        `).join("")
  }
    ...
    <div style="padding:20px 40px;border-top:1px solid #1E1E2E;text-align:center;">
      <p style="font-size:11px;color:#333350;margin:0;">
        © 2026 SubTrackr ·
        <a href="${appUrl}/settings" style="color:#555570;">Manage subscription</a>
      </p>
    </div>
  </div>`;
}
...
function onboardingDay3Template(name: string, appUrl: string): string {
  ...
  <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#0A0A0F;color:#E8E8F0;border-radius:16px;overflow:hidden;">
    ...
    <div style="padding:36px 40px;">
      <p style="font-size:15px;color:#A0A0B8;line-height:1.7;margin:0 0 20px;">
        Hey ${name || "there"},
      </p>
      <p style="font-size:14px;color:#A0A0B8;line-height:1.7;margin:0 0 24px;">
        Instead of adding subscriptions one by one, just paste your bank
        statement text and our AI finds ALL your subscriptions automatically.
      </p>
      <div style="background:#1A1A2A;border-radius:12px;padding:20px;margin-bottom:24px;border-left:3px solid #6C63FF;">
        ...
        <p style="margin:8px 0 0;font-size:13px;color:#888;line-height:1.6;">
          Open your banking app → View last 3 months statement →
          Copy and paste the text into SubTrackr AI Scanner.
          It finds everything in seconds.
        </p>
      </div>
      <div style="text-align:center;">
        <a href="${appUrl}/dashboard"
          style="display:inline-block;background:linear-gradient(135deg,#6C63FF,#3ECFCF);color:#fff;text-decoration:none;padding:14px 32px;border-radius:12px;font-weight:800;font-size:14px;">
          Try AI Scanner Now →
        </a>
      </div>
    </div>
  ...
  <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#0A0A0F;color:#E8E8F0;border-radius:16px;overflow:hidden;">
    ...
    <div style="padding:36px 40px;">
      <p style="font-size:15px;color:#A0A0B8;line-height:1.7;margin:0 0 24px;">
        Hey ${
    name || "there"
  }, you have been using SubTrackr for a week! Here is what we found:
      </p>
      <div style="display:flex;gap:16px;margin-bottom:24px;">
        <div style="flex:1;background:#1A1A2A;border-radius:12px;padding:20px;text-align:center;">
          <div style="font-size:32px;font-weight:900;color:#6C63FF;">${
    totalSubs || 0
  }</div>
          <div style="font-size:12px;color:#666680;margin-top:4px;">Subscriptions tracked</div>
        </div>
        <div style="flex:1;background:#1A1A2A;border-radius:12px;padding:20px;text-align:center;">
          <div style="font-size:32px;font-weight:900;color:#3ECFCF;">₹${
    monthlyCost || 0
  }</div>
          <div style="font-size:12px;color:#666680;margin-top:4px;">Monthly spend found</div>
        </div>
      </div>
      <div style="background:#1A1A2A;border-radius:12px;padding:20px;margin-bottom:24px;">
        <p style="margin:0 0 12px;font-size:13px;font-weight:700;color:#FFD700;">
...
function featureUpdateTemplate(
  ...
  <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#0A0A0F;color:#E8E8F0;border-radius:16px;overflow:hidden;">
    <div style="background:linear-gradient(135deg,#0D0A2E,#0A1A2E);padding:32px 40px;text-align:center;border-bottom:1px solid #2A2A4A;">
      <div style="font-size:13px;font-weight:700;color:#A89CFF;text-transform:uppercase;letter-spacing:2px;margin-bottom:8px;">
        What is New in SubTrackr
      </div>
    ...
    <div style="padding:36px 40px;">
      <p style="font-size:15px;color:#A0A0B8;line-height:1.7;margin:0 0 24px;">
        Hey ${name || "there"}, we have been busy building. Here is what is new:
      </p>
      ${
    features.map((f) => `
        <div style="background:#1A1A2A;border-radius:12px;padding:20px;margin-bottom:14px;display:flex;gap:16px;align-items:flex-start;">
          <span style="font-size:24px;flex-shrink:0;">${f.icon}</span>
          <div>
            <div style="font-weight:700;font-size:15px;color:#E8E8F0;margin-bottom:4px;">${f.title}</div>
            <div style="font-size:13px;color:#666680;line-height:1.6;">${f.desc}</div>
          </div>
        </div>
      `).join("")
  }
      ...
      <p style="font-size:13px;color:#555;line-height:1.7;">
        As always reply to this email with feedback. Every message goes directly to me.
      </p>
    </div>
    <div style="padding:20px 40px;border-top:1px solid #1E1E2E;text-align:center;">
      <p style="font-size:11px;color:#333350;margin:0;">
...
function reEngagementTemplate(
  ...
  <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;background:#0A0A0F;color:#E8E8F0;border-radius:16px;overflow:hidden;">
    ...
    <div style="padding:36px 40px;">
      <p style="font-size:15px;color:#A0A0B8;line-height:1.7;margin:0 0 20px;">
        Hey ${name || "there"}, you have not logged into SubTrackr in
        <strong style="color:#E8E8F0;">${daysSince} days</strong>.
      </p>
      <p style="font-size:14px;color:#A0A0B8;line-height:1.7;margin:0 0 24px;">
        In that time some of your subscriptions may have renewed —
        possibly ones you wanted to cancel before being charged.
      </p>
      <div style="background:#2A1A0A;border:1px solid #4A2A1A;border-radius:12px;padding:20px;margin-bottom:24px;">
        <p style="margin:0;font-size:14px;color:#FF9F43;font-weight:700;">
          ⚠️ Check your upcoming renewals
        </p>
        <p style="margin:8px 0 0;font-size:13px;color:#888;line-height:1.6;">
          Log in to see which subscriptions are renewing soon
          so you can cancel before getting charged.
        </p>
      </div>
      <div style="text-align:center;">
        <a href="${appUrl}/dashboard"
...
serve(async (req) => {
  ...
  try {
    ...
    if (!RESEND_API_KEY) throw new Error("RESEND_API_KEY secret is missing");

    // Parse request body
    const body = await req.json();
    const { type, to, name, data = {} } = body;

    console.log("Email type:", type, "To:", to);
    ...
    switch (type) {
      case "welcome":
        ...
        html = welcomeTemplate(name, APP_URL);
        break;

      case "pro_upgrade":
        subject = "You are now a SubTrackr Pro member! 🎉";
        html = proUpgradeTemplate(name, APP_URL);
        break;

      case "onboarding_day3":
        subject = "Did you know about AI email scanning? 🤖";
        html = onboardingDay3Template(name, APP_URL);
        break;
